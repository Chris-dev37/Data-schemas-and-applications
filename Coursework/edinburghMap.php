...
<html>
  <body>
    ...
    <script>
      var customLabel = {
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          center: new google.maps.LatLng(55.951035, -3.186439),
          zoom: 12
        });
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBEwVa1GKs4lLB4CVi4YQ2Ptaep70MV_x8&q=Edinburgh+GB&callback=initMap">
    </script>
  </body>
</html>